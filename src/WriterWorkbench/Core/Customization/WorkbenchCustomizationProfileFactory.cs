...
public static class WorkbenchCustomizationProfileFactory
{
    ...
    public static IReadOnlyList<CommandPlacement> CreateDefaultTopMenuPlacements()
    {
        ...
        [
            ...
            new CommandPlacement("menu", "top.view", "view.editor", AppCommandIds.ViewEditorOpen, "작품 수정", 10, new Dictionary<string, string>()),
            new CommandPlacement("menu", "top.view", "view.main", AppCommandIds.ViewMainOpen, "메인", 20, new Dictionary<string, string>()),
            new CommandPlacement("menu", "top.view", "view.preview", AppCommandIds.ViewPreviewToggle, "미리보기", 30, new Dictionary<string, string>()),
            new CommandPlacement("menu", "top.view", "view.html", AppCommandIds.ViewHtmlWorkbenchOpen, "작업대", 40, new Dictionary<string, string>()),
