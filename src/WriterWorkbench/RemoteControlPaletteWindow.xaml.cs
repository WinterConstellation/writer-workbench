...
public partial class RemoteControlPaletteWindow : Window
{
    public RemoteControlPaletteWindow()
    {
        InitializeComponent();
    }
    ...
    public void Render(WorkbenchCustomizationProfile profile, CommandRegistry registry)
    {
        ...
        RemoteButtonPanel.Children.Clear();
        foreach (var placement in placements)
        {
            ...
            RemoteButtonPanel.Children.Add(button);
        }
    }
